    ...
    <main class="form-signin w-100 m-auto">
        <form method="post" action="src/login.php">
            ...
            <div class="form-floating">
                <input type="text" class="form-control" name="txt-usuario" id="txt-usuario">
            ...
            <div class="form-floating input-group mb-3">
                ...
                <button class="btn btn-outline-secondary" type="button" id="btn-password" onclick="alternarSenha()"><i id="icon-password" class="bi bi-eye-fill"></i></button>
            </div>
