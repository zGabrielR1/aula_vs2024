...
// Inicializa o array de produtos se não existir
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['salvar'])) {
    ...
    header('Location: ../sistema.php?tela=produtos');
    exit();
}

// Processa a limpeza dos produtos
...
function listarProdutos() {
    if (empty($_SESSION['produtos'])) {
        ...
        echo "</table>";
        echo "<p style='margin-top: 15px;'><a href='produtos.php?acao=limpar' style='background-color: #f44336; color: white; padding: 8px 16px; text-decoration: none; border-radius: 4px;' onclick=\"return confirm('Tem certeza que deseja limpar todos os produtos?')\">Limpar Produtos</a></p>";
    }
}
