...
function salvarCliente() {
    ...
    var cidade      = document.getElementById('list-cidade').value;
    ...
    $.ajax({
        ...
        success: function(resposta) {
            ...
            clientes.forEach(function(cliente) {
                ...
                var sexo = cliente['sexo'] == 'f' ? 'Feminino' : 'Masculino';
                linha.innerHTML = `
    ...
    $.ajax({
        ...
        success: function(resposta) {
            if (resposta['status'] === 'sucesso') {
                ...
                setTimeout(() => {
                    document.getElementById('list-cidade').value = cliente['cidade'];
                }, 500);  
                if (cliente['sexo'] === 'f') {
