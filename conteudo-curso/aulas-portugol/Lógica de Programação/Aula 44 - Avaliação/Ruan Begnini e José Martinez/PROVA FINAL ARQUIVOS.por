programa{
	...
	funcao logico busca(cadeia nome_produto) {
		inteiro arquivo = Arquivos.abrir_arquivo("D:/Ruan/Portugol/Arquivos/produtos.txt", 0)
		...
		faca {
			...
			escolha (opcao) {
				caso 1:
					...
					inteiro arquivo_produtos = Arquivos.abrir_arquivo("D:/Ruan/Portugol/Arquivos/produtos.txt", 2)
					inteiro arquivo_valores = Arquivos.abrir_arquivo("D:/Ruan/Portugol/Arquivos/valores.txt", 2)
				...
				caso 2:
					...
					qtd_produtos = -1
					inteiro imprimir_produtos = Arquivos.abrir_arquivo("D:/Ruan/Portugol/Arquivos/produtos.txt", 0)
					inteiro imprimir_valores = Arquivos.abrir_arquivo("D:/Ruan/Portugol/Arquivos/valores.txt", 0)
					cadeia str_soma
					real soma, soma2 = 0
				...
				caso 3:
					...
					inteiro arquivo = Arquivos.abrir_arquivo("D:/Ruan/Portugol/arquivos/"+"venda_"+nome_arquivo+".txt", 1)
					...
					arquivo = Arquivos.abrir_arquivo("D:/Ruan/Portugol/arquivos/"+"venda_"+nome_arquivo+".txt", 0)
					...
					arquivo = Arquivos.abrir_arquivo("D:/Ruan/Portugol/arquivos/"+"venda_"+nome_arquivo+".txt", 2)
 ...
 * @POSICAO-CURSOR = 5900; 
 * @PONTOS-DE-PARADA = ;
 * @SIMBOLOS-INSPECIONADOS = {total, 159, 10, 5};
